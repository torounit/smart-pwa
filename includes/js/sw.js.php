...
const NOT_AVAILABLE_KEY = '<?php echo Smart_PWA\App::home_url( get_page_uri( get_option( 'smart_pwa_not_available_page', false ) ) ); ?>';
const MANIFEST_URL = '<?php echo Smart_PWA\App::get_manifest_url(); ?>';
